...
const bronx_head = [7];
const bronx_sub = [
  12, 13, 22, 23, 24, 25, 42, 43, 44, 45, 46, 47, 48, 49, 82, 83, 84, 85, 86,
  87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97,
];
const manhattan_head = [6];
const manhattan_sub = [
  10, 11, 18, 19, 20, 21, 34, 35, 36, 37, 38, 39, 40, 41, 66, 67, 68, 69, 70,
  71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81,
];
const brooklyn_head = [8];
const brooklyn_sub = [
  14, 15, 26, 27, 28, 29, 50, 51, 52, 53, 54, 55, 56, 57, 98, 99, 100, 101, 102,
